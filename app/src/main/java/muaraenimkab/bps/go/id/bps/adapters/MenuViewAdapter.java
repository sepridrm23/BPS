...
//        Glide.with(context).load(Utilities.getBaseURLLogo()+mList.get(position).getLogo()).into(holder.ivLogo);
        Picasso .get().load(Utilities.getURLLogo() + mList.get(position).getLogo())
                .fit()
                .centerCrop()
                .into(holder.ivLogo);
